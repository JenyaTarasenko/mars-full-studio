...
import Mars from "../../assets/image/mars2.svg";
import EarthDestop from "../../assets/image/mars1.svg";
import EartMobile from "../../assets/image/mars1-mobile.svg";
    ...
    return(
        <>
            <footer className="flex items-center justify-center flex-col relative mt-[200px]">
                ...
                <img src={EarthDestop} alt="logo-mars-studio" className="w-full  object-contain mt-[400px] absolute z-[20] hidden md:block"/>
                <img src={EartMobile} alt="logo-mars-studio" className="w-full  object-contain mt-[400px] absolute z-[20] block md:hidden"/>
