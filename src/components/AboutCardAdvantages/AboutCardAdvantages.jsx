        ...
        <>
            <div className="flex items-center justify-center flex-col gap-3 lg:flex-row mt-[100px]">
                <div className="h-[400px] lg:w-[400px] w-[300px]  sm:w-[500px] bg-[#D9D9D9]/[0.04] rounded-[40px] relative flex transition-transform duration-300 ease-in-out hover:scale-105 active:scale-100">
                    ...
                    <img src="/image/raduga-card.svg" alt="rainbow" className="absolute h-[400px] z-[-1] lg:translate-x-[240px] translate-x-[140px] sm:translate-x-[340px] "/>
                    <img src="/image/gradient-orange.svg" alt="gradient" className="absolute translate-x-[-20px] translate-y-[160px] h-[300px] z-[-1]"/>
                ...
                <div className="h-[400px] w-[300px] sm:w-[500px] bg-[url('/image/bg-cardabout.svg')] rounded-[40px] relative flex transition-transform duration-300 ease-in-out hover:scale-105 active:scale-100 ">
            ...
            <div className="flex items-center justify-center flex-col gap-3 lg:flex-row mt-2">
                ...
                <div className="h-[400px] w-[300px] sm:w-[500px] bg-[#D9D9D9]/[0.04] rounded-[40px] relative flex transition-transform duration-300 ease-in-out hover:scale-105 active:scale-100 ">
                    <img src="/image/card-about3.svg" alt="logo-decor" className="h-[400px] translate-x-[-5px] translate-y-[-25px] sm:translate-y-[0px] z-[-1] "/>
                ...
                <div className="h-[400px] lg:w-[400px] w-[300px]  sm:w-[500px] bg-[#D9D9D9]/[0.04] rounded-[40px] relative flex transition-transform duration-300 ease-in-out hover:scale-105 active:scale-100">
                    ...
                    <img src="/image/card-about4.svg" alt="logo-decor" className="absolute h-[400px] z-[-1] translate-x-[-1px] lg:translate-x-[5px] translate-y-[50px] sm:translate-y-[0px]"/>
                    {/* <p className="font-jost text-gray-400 font-normal text-xs uppercase tracking-widest px-10 translate-y-[360px]">качество</p> */}
